...
3	Shopping-cart	Fix ubermelon website using Flask and jinja	100
4	oo-drawing	Draw stuff using cs1 drawining program to get comfortable with object orientation	100
5	Bootstrap	Create webpage matching png using bootstrap	100
\.
